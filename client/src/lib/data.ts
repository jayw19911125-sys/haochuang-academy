...
- 語氣：專業但易懂（客戶是老闆，不是行銷人）`,
    ...
    sections: [
      {
        ...
        tableData: {
          headers: ["平台", "最適客戶類型", "月費", "自動化程度", "優勢"],
          rows: [
            ["LINE OA", "一般消費品、餐飲、服務", "$0-3000", "★★★★☆", "台灣滲透率最高，轉換率最穩定"],
            ["Skool", "社群、IP、知識型", "$0-5000", "★★★☆☆", "社群氛圍強，粉絲黏著度高"],
            ["課程平台", "線上課程、高客單價", "$500-2000", "★★★★★", "自動化最完整，漏斗最清晰"],
            ["私有群組", "高端客戶、VIP", "$0", "★★☆☆☆", "完全掌控，但需人工維護"]
          ]
        }
      },
      {
        ...
        steps: [
          {
            title: "第 1 層：短影音曝光",
            description: "目標：完播率 ≥ 50%\n月度目標：1000+ 次觀看\n\n【優化方向】Hook 強度、前 3 秒吸引力、平台算法優化",
            ai: "AI 生成 10+ 個不同 Hook 進行 A/B 測試"
          },
          {
            title: "第 2 層：留言轉私訊",
            description: "目標：互動率 ≥ 3%（留言 + 分享）\n月度目標：30+ 條有效留言\n\n【優化方向】CTA 設計、問題引導、互動獎勵",
            ai: "AI 生成 CTA 文案變體，測試哪種最容易激發互動"
          },
          {
            title: "第 3 層：私訊進私域",
            description: "目標：私訊轉私域加入率 ≥ 60%\n月度目標：18+ 人進入私域\n\n【優化方向】私訊回覆速度、進私域誘因（免費資源、社群感）",
            ai: "AI 生成自動回覆文案，激發用戶進私域的動力"
          },
          {
            title: "第 4 層：私域培育",
            description: "目標：活躍度 ≥ 40%（每週互動）\n月度目標：7+ 人參與互動\n\n【優化方向】內容頻率、價值提供、社群歸屬感",
            ai: "AI 根據用戶行為自動推薦內容、自動分類用戶"
          },
          {
            title: "第 5 層：轉換機會",
            description: "目標：轉換率 ≥ 15%（進私域的人中）\n月度目標：2-3 人購買\n\n【優化方向】產品介紹、限時優惠、見證分享",
            ai: "AI 分析用戶行為，精準推薦最適合的產品"
          },
          {
            title: "第 6 層：復購與推薦",
            description: "目標：復購率 ≥ 30%、推薦率 ≥ 20%\n月度目標：1 人復購、1 人推薦新客\n\n【優化方向】客後服務、社群維繫、推薦獎勵",
            ai: "AI 自動發送客後關懷、推薦激勵訊息"
          }
        ]
      },
      {
  ...
  },
  {
    ...
    sections: [
      {
        id: "ch12-s1",
        title: "B2B 社群戰場：LinkedIn 對話窗廣告",
        type: "table",
        content: "2026 年 LinkedIn 最新功能。對話窗廣告無需離開平台，轉換率比傳統廣告高 40-60%：",
        tableData: {
          headers: ["功能", "傳統廣告", "對話窗廣告", "提升幅度"],
          rows: [
            ["用戶體驗", "點擊 → 跳轉外站", "點擊 → 私訊對話", "+40-60%"],
            ["轉換成本", "$8-15/次", "$5-10/次", "-30-40%"],
            ["自動化", "需手動回覆", "AI 聊天機器人", "自動化 80%"],
            ["資格審核", "手動篩選", "Bot 自動審核", "效率 ↑ 5 倍"]
          ]
        }
      },
      {
        id: "ch12-s2",
        title: "B2C 社群戰場：短影音平台對比",
        type: "table",
        content: "三大短影音平台 2026 年的核心差異。選錯平台，效果相差 10 倍：",
        tableData: {
          headers: ["平台", "完播率目標", "最佳發布時段", "核心優勢", "適合產業"],
          rows: [
            ["TikTok", "≥ 65%", "19:00-23:00", "創意爆發、年輕受眾", "快消、美妝、服飾"],
            ["IG Reels", "≥ 55%", "18:00-22:00", "品牌調性、視覺一致", "高端、生活風格"],
            ["YouTube Shorts", "≥ 55%", "20:00-23:00", "教育性、長期價值", "知識、教育、B2B"]
          ]
        }
      },
      {
    ...
    sections: [
      {
        ...
        title: "工具選擇決策樹",
        type: "text",
        content: "**你需要什麼？**\n\n**需要快速產量（日產 10+ 支）**\n→ ShortGenius / VEED.IO / Quso\n\n**需要長轉短（YouTube → 短片）**\n→ OpusClip / Klap / 2Short AI\n\n**需要多語言支援**\n→ Klap / Synthesia / VEED.IO\n\n**需要虛擬主播風格**\n→ Synthesia / 2Short AI\n\n**需要無臉影片**\n→ SendShort / CapCut\n\n**需要專業剪輯**\n→ Adobe Premiere / CapCut Pro"
      },
      {
        id: "ch13-s2",
        title: "12 款工具成本對比",
        type: "table",
        content: "根據月度使用量選擇最經濟的方案。成本差異可達 10 倍：",
        tableData: {
          headers: ["工具", "月費", "月度產量", "成本/支", "評分"],
          rows: [
      ...
      {
        id: "ch13-s3",
        title: "2026 最優混合策略：70/30 配置",
        type: "text",
        content: "**70% AI 自動化**\n- 日常高產量內容（ShortGenius 或 Quso）\n- 快速 A/B 測試（OpusClip 長轉短）\n- 批量文案生成（Manus）\n- 自動排程發布\n\n**30% 人工精製**\n- 旗艦內容（品牌信任度高）\n- 複雜創意（需要人工審美）\n- 客戶特殊要求\n\n**結果**\n- 互動率提升 35-45%\n- 成本下降 50-70%\n- 月度產量 ↑ 10 倍"
      }
    ]
  },
  {
    ...
    sections: [
      {
        id: "ch14-s1",
        title: "Meta 深層漏斗優化（DFO）",
        type: "text",
        content: "**什麼是 DFO？**\n深層漏斗優化（Deep Funnel Optimization）是 Meta 2026 年推出的新功能。不再只優化轉換，而是優化整個漏斗的每一層。\n\n**三層漏斗**\n1. **Awareness（認知層）** - 優化觸及和完播率\n2. **Consideration（考慮層）** - 優化點擊和加購率\n3. **Conversion（轉換層）** - 優化購買和復購率\n\n**效果提升**\n- 轉換率 ↑ 20-40%\n- CPA 下降 15-25%\n- ROAS 提升 1.5-2 倍"
      },
      {
        id: "ch14-s2",
        title: "AI 廣告創意自動化",
      ...
      },
      {
        ...
        title: "12 週完整執行計劃",
        type: "steps",
        content: "從系統建立到規模化的完整路徑：",
        steps: [
          {
            title: "第 1-4 週：建立期",
            description: "目標：建立基礎系統、測試 3-5 個廣告素材\n\n【具體任務】\n- 確定目標受眾和轉換事件\n- 製作 5 個廣告素材\n- 設定 DFO 三層漏斗\n- 每日監控 ROAS",
            ai: "AI 生成廣告文案 10+ 版本、自動 A/B 測試"
          },
          {
            title: "第 5-8 週：成長期",
            description: "目標：找到最優廣告組合、ROAS ≥ 2.5\n\n【具體任務】\n- 擴大預算 20-30%\n- 測試新的受眾群體\n- 優化轉換漏斗\n- 分析爆款素材因素",
            ai: "AI 自動分析數據、推薦預算分配"
          },
          {
            title: "第 9-12 週：規模期",
            description: "目標：達到目標 ROAS、月度營收目標\n\n【具體任務】\n- 預算增加 50%\n- 測試新的轉換事件\n- 建立自動化優化規則\n- 準備下季度計劃",
            ai: "AI 自動優化預算分配、自動生成月報"
          }
        ]
      }
    ]
